...
import { faUser, faSignOutAlt, faMicrochip, faPlus } from '@fortawesome/free-solid-svg-icons'
...
<template>
  <header
    class="fixed top-0 left-0 right-0 flex justify-between items-center px-8 py-4 bg-[#1E1E1E] shadow-lg z-50"
  >
    <div class="flex items-center">
      <RouterLink
        to="/"
        class="text-2xl font-normal text-white hover:text-[#4C8FE9] transition-colors"
      >
        SensaReal
      </RouterLink>
    </div>
